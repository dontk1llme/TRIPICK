...
public interface MemberBadgeRepository extends JpaRepository<MemberBadge, Long> {
    @Query("SELECT new com.tripick.mz.auth.dto.response.MemberBadgeResDto(mb.badge, mb.achieved, mb.achievedDate, mb.visitCount) FROM MemberBadge mb")
    List<MemberBadgeResDto> findByMemberWithoutMemberInfo(Member memebr);
}
